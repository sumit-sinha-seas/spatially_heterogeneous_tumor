...
for i=1:size(intersecting_label,1)
  %  i
    ...
    for j=1:size(time,2)
         mag_delta=norm(req_track_particle(j,:)-req_track_particle(1,:));
         scat_every_cell(j,i)=(heaviside((length_scale)-mag_delta));
    end
    if(dis_com<30)
...
figure(2)
loglog(time,av_scat_layer_1,'-','LineWidth',2)
hold on
loglog(time,av_scat_layer_2,'-','LineWidth',2)
loglog(time,av_scat_layer_3,'-','LineWidth',2)
loglog(time,av_scat_layer_4,'-','LineWidth',2)
loglog(time,av_scat_layer_5,'-','LineWidth',2)
loglog(time,av_scat_layer_6,'-','LineWidth',2)
loglog(time,av_scat_layer_7,'-','LineWidth',2)
loglog(time,av_scat_layer_8,'-','LineWidth',2)
loglog(time,av_scat_layer_9,'-','LineWidth',2)
loglog(time,av_scat_layer_10,'-','LineWidth',2)
loglog(time,av_scat_layer_extra,'-','LineWidth',2)